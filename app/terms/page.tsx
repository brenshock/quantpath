...
export default function TermsPage() {
  return <LegalPage title="Terms of use" updated="September 16, 2026">
    ...
    <section><h2>Acceptable use</h2><p>Use QuantPath reasonably and lawfully. Do not interfere with the service, misuse it, or use it to violate another person’s rights. Access may be limited when necessary to protect the service and its users.</p></section>
